...
function add_remove_title_attributes_admin_menu() {
	add_options_page('Remove Title Attributes', 'Remove Title Attributes', 9, __FILE__, 'remove_title_attributes_admin_menu');
}
...
class WP_Widget_Recent_Posts_No_Title_Attributes extends WP_Widget {
	...
	function WP_Widget_Recent_Posts_No_Title_Attributes() {
		...
		$this->WP_Widget('recent-posts-no-title-attributes', __('Recent Posts (No Title Attributes)'), $widget_ops);
